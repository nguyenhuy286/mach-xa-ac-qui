...
#define INA288_ADCCONFIG_2		0xBFC5 //Avg ADC = 256 sample, continuous shunt & bus, time convert =1.052ms
#define INA288_CURRLSBCALC_30	0x0800 
#define INA288_TEMPCOCONFIG_4 0x0000
#define INA288_DIAG_ALRT			0x8001 // Latch mode, normal
